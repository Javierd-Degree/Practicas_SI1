...
WITH current_prices AS (SELECT products.price/(1.02^(DATE_PART('year', NOW()) - DATE_PART('year', orderdate))) AS price, orderdetail.orderid AS orderid, orderdetail.prod_id AS prod_id FROM 
